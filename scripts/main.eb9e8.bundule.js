...
function Topbar() {
    ...
    const getWeAudBalance = (0,react.useCallback)(/*#__PURE__*/ (0,_async_to_generator/* default */.Z)(function*() {
        ...
        erc20Contract == null ? void 0 : erc20Contract.balanceOf(account).then((res)=>{
            setWeAudBalance(units_lib_esm.formatEther(res == null ? void 0 : res.toString()));
        });
    }), [
        account,
        erc20Contract
                                                    ...
                                                    children: ({ active , close  })=>/*#__PURE__*/ (0,jsx_runtime.jsxs)(jsx_runtime.Fragment, {
                                                            children: [
                                                                ...
                                                                chainId !== 5 ? /*#__PURE__*/ (0,jsx_runtime.jsx)("button", {
                                                                    ...
                                                                    className: "bg-[#EC364C] bg-opacity-10 w-full rounded-[7.1429rem] px-[3px] mt-[1.2143rem] h-[2rem] text-[#EC364C]",
                                                                    children: "Please switch to the Goerli Testnet"
...
const Sidebar = ()=>{
    return /*#__PURE__*/ (0,jsx_runtime.jsx)("div", {
        className: "w-[18.9286rem] sticky top-[5.8rem] h-min pt-6 hidden md:block",
        children: /*#__PURE__*/ (0,jsx_runtime.jsx)("div", {
...
const CreateInvoice = ()=>{
    ...
    return /*#__PURE__*/ (0,jsx_runtime.jsxs)("div", {
        className: "p-12 overflow-auto [&::-webkit-scrollbar]:hidden",
        children: [
            /*#__PURE__*/ (0,jsx_runtime.jsx)(components_PageHeader, {
...
const Transfer = ({ onClose , isPreview , recvId , amount , isForTrade =false  })=>{
    ...
    const [failureText, setFailureText] = (0,react.useState)('');
    const [txHash, setTxHash] = (0,react.useState)('');
    const [amountToTransfer, setAmountToTransfer] = (0,react.useState)(isForTrade ? BigNumberInstance(units_lib_esm.formatEther(amount || '0')).toFixed(2) : '');
    const [recipientAddress, setRecipientAddress] = (0,react.useState)('');
    const [isCopied, onCopy] = useCopyClipboard();
    const formattedAmount = maskedCurrency.resolve(units_lib_esm.formatEther(amount || '0.00'));
    ...
    const handleTransfer = (0,react.useCallback)(/*#__PURE__*/ (0,_async_to_generator/* default */.Z)(function*() {
        ...
        try {
            setLoading(true);
            const gasEstimated = yield recvDelegateContract.estimateGas.transferFrom(recvId, isForTrade ? recipientAddress : account, units_lib_esm.parseEther(amountToTransfer));
            const tx = yield recvDelegateContract.transferFrom(recvId, isForTrade ? recipientAddress : account, units_lib_esm.parseEther(amountToTransfer), {
                gasLimit: gasEstimated == null ? void 0 : gasEstimated.mul(110).div(100)
            });
            setTxHash(tx.hash);
    ...
    const setTransferAll = ()=>{
        setAmountToTransfer(BigNumberInstance(units_lib_esm.formatEther(amount || '0')).toFixed(2));
    };
    ...
    const isValidAmount = !amountToTransfer || !!amountToTransfer && (isForTrade ? units_lib_esm.parseEther(amountToTransfer).lte(amount || '0') : units_lib_esm.parseEther(amountToTransfer).lt(amount || '0'));
    const isValidReceipientAddress = !recipientAddress || !!recipientAddress && lib_esm.isAddress(recipientAddress);
    const canTransfer = !!amountToTransfer && isValidAmount && (isForTrade ? !!recipientAddress && isValidReceipientAddress : true);
    const balance = isValidAmount ? BigNumberInstance(units_lib_esm.formatEther(amount || '0')).minus(!!amountToTransfer ? amountToTransfer : '0').toFixed(2) : '0.00';
            ...
            lState === 'finalised' ? /*#__PURE__*/ (0,jsx_runtime.jsxs)("div", {
                ...
                children: [
                    ...
                    /*#__PURE__*/ (0,jsx_runtime.jsxs)("a", {
                        href: (0,dist/* getExplorerLink */.E8)(chainId || 5, (data == null ? void 0 : data.txHash) || (invoice == null ? void 0 : invoice.txHash) || '', dist/* ExplorerDataType.TRANSACTION */.rl.TRANSACTION),
                        target: "_blank",
...
const Trade = ()=>{
    ...
    return /*#__PURE__*/ (0,jsx_runtime.jsxs)("div", {
        ...
        children: [
                    ...
                    /*#__PURE__*/ (0,jsx_runtime.jsx)("div", {
                        ...
                        children: activeReceivables == null ? void 0 : activeReceivables.sort((a, b)=>{
                            ...
                            return /*#__PURE__*/ (0,jsx_runtime.jsx)(components_PreviewBox, {
                                ...
                                btnText: 'Trade',
                                state: stateConverter(recv.state || '0', recv.invoice.dueDate),
                                btnIcon: /*#__PURE__*/ (0,jsx_runtime.jsx)(TransferIcon, {}),
                                contractAddr: receivableDelegateAddress,
                                showInvoiceImage: toggleInvoiceImageDisplay
                            }, idx);
                        })
            ...
            listOnMarketModal && /*#__PURE__*/ (0,jsx_runtime.jsxs)(components_Modal, {
                ...
                children: [
                    ...
                    /*#__PURE__*/ (0,jsx_runtime.jsx)(GetPaid_ItemButton, {
                        url: "https://testnet.rarible.com/items?sell=true",
                        icon: rarible_namespaceObject,
                        title: "Rarible",
                        onClose: ()=>setListOnMarketModal(false)
                    }),
                    /*#__PURE__*/ (0,jsx_runtime.jsx)(GetPaid_ItemButton, {
                        url: "https://goerli.looksrare.org/accounts/me",
                            ...
                            children: [
                                ...
                                !canPay ? /*#__PURE__*/ (0,jsx_runtime.jsx)(components_Button, {
                                    ...
                                    children: !hasSufficientAUD ? /*#__PURE__*/ (0,jsx_runtime.jsx)(jsx_runtime.Fragment, {
                                        children: "Insufficient balance of weAUD in your wallet"
                                    }) : /*#__PURE__*/ (0,jsx_runtime.jsxs)(jsx_runtime.Fragment, {
                                        children: [
...
/******/ __webpack_require__.O(0, [589,986,998], () => (__webpack_exec__(67602)));
