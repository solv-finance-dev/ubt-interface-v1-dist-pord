...
`;
const InvoiceSearch = `
  query ($searchText: String, $pageSize: Int!, $skip: Int!, $sortBy: String, $sortDirection: String) {
    invoiceSearch(
      text: $searchText,
      first: $pageSize,
      skip: $skip,
                ...
                lState === 'finalised' ? /*#__PURE__*/ (0,jsx_runtime.jsxs)("div", {
                    ...
                    children: [
                        /*#__PURE__*/ (0,jsx_runtime.jsxs)("button", {
                            ...
                            className: (0,tw_merge/* twMerge */.m)('h-[36px] w-[90%] fill-white border-0 flex items-center justify-center gap-2 rounded-2xl bg-[#7918F5] text-white text-sm font-medium', btnDisabled && 'cursor-not-allowed opacity-50'),
