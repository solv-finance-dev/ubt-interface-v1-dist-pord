...
function Dashboard() {
    ...
    const { openModal: openWalletModel , setConnections  } = (0,dist/* useConnectModal */.We)();
    ...
    const onBtnClick = (0,react.useCallback)((url)=>{
