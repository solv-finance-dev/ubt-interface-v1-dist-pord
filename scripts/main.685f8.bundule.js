...
const getDayDiffs = (epoch, dd = defaultDate)=>{
    return dayJsAdapter.getDiff(dayJsAdapter.date(new Date(Number(epoch) * 1000)), dayJsAdapter.date(dd), 'days'); // inclusive due date
};
                ...
                children: successText && /*#__PURE__*/ (0,jsx_runtime.jsxs)("div", {
                    ...
                    children: [
                        ...
                        /*#__PURE__*/ (0,jsx_runtime.jsx)(react_router_dom_dist/* Link */.rU, {
                            to: "/my-issurance",
                            className: (0,tw_merge/* twMerge */.m)('w-full gap-2 fill-white inline-flex items-center rounded-[7.1429rem] h-[3.7143rem] justify-center px-4 py-2 border border-[#7918F5] text-base font-medium text-white hover:bg-#7918F5', 'mt-[8px] text-[#7918F5]'),
