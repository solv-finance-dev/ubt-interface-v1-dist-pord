...
const ConfirmModal = (props)=>{
    ...
    const onCreatingInvoice = (0,react.useCallback)(/*#__PURE__*/ (0,_async_to_generator/* default */.Z)(function*() {
        ...
        try {
            ...
            const estimateGas = yield contract == null ? void 0 : contract.estimateGas.mint(invoice.buyerAddr, units_lib_esm.parseEther(`${total}`), invoiceInfo);
            const tx = yield contract == null ? void 0 : contract.mint(invoice.buyerAddr, units_lib_esm.parseEther(`${total}`), invoiceInfo, {
                gasLimit: estimateGas.mul(1.1)
            });
            setTxHash(tx.hash);
...
const Transfer = ({ onClose , isPreview , recvId , amount  })=>{
    ...
    const handleTransfer = (0,react.useCallback)(/*#__PURE__*/ (0,_async_to_generator/* default */.Z)(function*() {
        ...
        try {
            setLoading(true);
            const estimateGas = yield recvDelegateContract.estimateGas.transferFrom(recvId, recipientAddress, units_lib_esm.parseEther(amountToTransfer));
...
const Claim = ({ isPreview , recvId , claimAmount , onClose  })=>{
    ...
    const handleClaim = (0,react.useCallback)(/*#__PURE__*/ (0,_async_to_generator/* default */.Z)(function*() {
        ...
        try {
            setLoading(true);
            const estimateGas = yield recvDelegateContract.estimateGas.withdraw(account, recvId);
    ...
    const onConfirming = (0,react.useCallback)(/*#__PURE__*/ (0,_async_to_generator/* default */.Z)(function*() {
        ...
        try {
            ...
            const tx = yield invoiceDelegatecontract.confirm(invoice == null ? void 0 : invoice.id, {
                gasLimit: gasEstimated == null ? void 0 : gasEstimated.mul(1.1)
            });
            setTxHash(tx.hash);
            yield tx.wait();
...
const PaymentModal = (props)=>{
    ...
    const handleApprove = (0,react.useCallback)(/*#__PURE__*/ (0,_async_to_generator/* default */.Z)(function*() {
        ...
        try {
            setLoading(true);
            const estimateGas = yield erc20Contract.estimateGas.approve(invoiceDelegateAddress, amount);
    ...
    const handlePay = (0,react.useCallback)(/*#__PURE__*/ (0,_async_to_generator/* default */.Z)(function*() {
        ...
        try {
            setLoading(true);
            const estimateGas = yield invoiceDelegatecontract.estimateGas.pay(invoice == null ? void 0 : invoice.id);
...
const App = ()=>{
    ...
    (0,react.useEffect)(()=>{
        ...
        if (mode !== 'development' && (!account || chainId !== 5) && pathname !== '/') {
            navigate('/');
        }
    }, [
        account,
