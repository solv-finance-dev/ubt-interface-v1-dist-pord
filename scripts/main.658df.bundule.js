...
const invoiceSvgAddress = '0xc1381A45E2f2F9BC0Ed881406580a29144A6A895';
const receivableDelegateAddress = '0x2eceE1D2088141B93bf276758914Be4f9818B8aF'; //'0xa552793238f0D99E531c0CC1D75280F78425Bb35';
const receivableSvgAddress = '0xc114218D9bd64bdbEa9aD9e7509ccA74EF005e7f';
...
// EXTERNAL MODULE: ./node_modules/.pnpm/react-use@17.4.0_biqbaboplfbrettd7655fr4n2y/node_modules/react-use/esm/useIdle.js
var useIdle = __webpack_require__(28834);
...
// EXTERNAL MODULE: ./node_modules/.pnpm/react-use@17.4.0_biqbaboplfbrettd7655fr4n2y/node_modules/react-use/esm/useLocalStorage.js
var useLocalStorage = __webpack_require__(92696);
...
function useFetchingSvg(svgContractAddr, delegateAddr, invoiceId) {
    ...
    const [value, setValue] = (0,useLocalStorage/* default */.Z)(`${delegateAddr}-${invoiceId}`);
    (0,react.useEffect)(()=>{
        if (!invoiceId || svg) return;
        if (value && !svg) {
            setSvg(value);
        }
        ...
        function _getSvgByTokenId() {
            _getSvgByTokenId = (0,_async_to_generator/* default */.Z)(function*() {
                if (!svgContract || !invoiceId || svg) return;
...
const SvgBox = ({ svg , className  })=>{
    ...
    /*#__PURE__*/ (0,jsx_runtime.jsx)("div", {
        ...
        children: !!svg ? /*#__PURE__*/ (0,jsx_runtime.jsx)("embed", {
            src: svg
        }) : /*#__PURE__*/ (0,jsx_runtime.jsx)("div", {
            role: "status",
...
const Activity = ()=>{
    ...
    const handleCopy = (0,react.useCallback)((text, content, idx)=>{
        setCopiedText(text);
        onCopy(content);
        setCopiedIdx(idx);
        setTimeout(()=>{
                                    ...
                                    /*#__PURE__*/ (0,jsx_runtime.jsxs)("div", {
                                        ...
                                        children: [
                                            ...
                                            isCopiedAddr && copiedIdx === idx ? /*#__PURE__*/ (0,jsx_runtime.jsx)(CheckIcon, {}) : /*#__PURE__*/ (0,jsx_runtime.jsx)("span", {
                                                className: "cursor-pointer",
                                                onClick: ()=>handleCopy('addr', activity.buyerAddr, idx),
                                                    ...
                                                    /*#__PURE__*/ (0,jsx_runtime.jsxs)("div", {
                                                        ...
                                                        children: [
                                                            ...
                                                            isCopiedHash && copiedIdx === idx ? /*#__PURE__*/ (0,jsx_runtime.jsx)(CheckIcon, {}) : /*#__PURE__*/ (0,jsx_runtime.jsx)("span", {
                                                                className: "cursor-pointer",
                                                                onClick: ()=>handleCopy('hash', activity.txHash, idx),
                                                                children: /*#__PURE__*/ (0,jsx_runtime.jsx)(CopyIcon, {})
                                                            })
                                                        ]
                                                    })
...
const PreviewBox = (props)=>{
    ...
    return /*#__PURE__*/ (0,jsx_runtime.jsxs)("div", {
        className: "bg-white rounded-md flex flex-col p-3 w-[343px] h-[281px]",
        children: [
            /*#__PURE__*/ (0,jsx_runtime.jsxs)("div", {
                className: "rounded-md bg-[#F8F8F9] cursor-pointer w-[319px] h-[209px]",
                onClick: ()=>handlePreview(data),
                children: [
                    /*#__PURE__*/ (0,jsx_runtime.jsx)("div", {
                        className: (0,tw_merge/* twMerge */.m)('flex justify-end h-[13px] items-center rounded-t-md bg-[#FFAD32]', lState === 'tbc' && `bg-[#597EFF]`, lState === 'finalised' && `bg-[#6E747A]`, lState === 'paid' && `bg-[#13C57B]`, lState === 'overdue' && `bg-[#EC364C]`),
                        children: /*#__PURE__*/ (0,jsx_runtime.jsx)("span", {
                            className: "pr-3 font-semibold text-[6px] text-white uppercase",
                            children: state
                        })
                    }),
                    /*#__PURE__*/ (0,jsx_runtime.jsxs)("div", {
                        ...
                        children: [
                            /*#__PURE__*/ (0,jsx_runtime.jsx)("div", {
                                ...
                                children: /*#__PURE__*/ (0,jsx_runtime.jsxs)("span", {
                                    className: "text-black font-semibold text-[10px] uppercase",
                                    children: [
                                        title,
                                        " ",
                                        /*#__PURE__*/ (0,jsx_runtime.jsxs)("span", {
                            ...
                            /*#__PURE__*/ (0,jsx_runtime.jsxs)("div", {
                                className: "flex pt-[12px] font-semibold items-center",
                                children: [
                                    /*#__PURE__*/ (0,jsx_runtime.jsxs)("div", {
                                        children: [
                                            /*#__PURE__*/ (0,jsx_runtime.jsx)("div", {
                                                className: "text-[#BCC1C5] text-[6px] mb-1",
                                                children: "Invoice from"
                                            }),
                                            /*#__PURE__*/ (0,jsx_runtime.jsx)("p", {
                                                className: "text-black text-[10px] w-[96px] h-[26px] line-clamp-2",
                                                children: invoice.sellerName
                                            }),
                                            /*#__PURE__*/ (0,jsx_runtime.jsxs)("div", {
                                                className: "text-[#BCC1C5] text-[6px] mt-[6px] uppercase",
                                                children: [
                                                    "ABN: ",
                                                    invoice.sellerAbn
                                                ]
                                    ...
                                    /*#__PURE__*/ (0,jsx_runtime.jsxs)("div", {
                                        children: [
                                            ...
                                            /*#__PURE__*/ (0,jsx_runtime.jsxs)("div", {
                                                className: "text-[#BCC1C5] text-[6px] pt-[6px] uppercase",
                                                children: [
                                                    "ABN: ",
                                                    invoice.sellerAbn
                                                ]
                            ...
                            /*#__PURE__*/ (0,jsx_runtime.jsxs)("div", {
                                className: "pt-[24px] flex items-center font-semibold",
                                children: [
                                    /*#__PURE__*/ (0,jsx_runtime.jsx)("span", {
                                        className: "text-[#BCC1C5] text-[6px] uppercase",
                                        children: "Invoice date"
                                    }),
                                    /*#__PURE__*/ (0,jsx_runtime.jsx)("span", {
                                        className: "text-black text-[10px] pl-[38px]",
                            ...
                            /*#__PURE__*/ (0,jsx_runtime.jsxs)("div", {
                                className: "pt-[10px] flex items-center font-semibold",
                                children: [
                                    /*#__PURE__*/ (0,jsx_runtime.jsx)("span", {
                                        className: "text-[#BCC1C5] text-[6px] uppercase",
                                        children: "Due date"
                                    ...
                                    /*#__PURE__*/ (0,jsx_runtime.jsxs)("span", {
                                        className: "text-black text-[10px] flex-1 pl-[50px]",
                                        children: [
                            ...
                            /*#__PURE__*/ (0,jsx_runtime.jsxs)("div", {
                                ...
                                children: [
                                    ...
                                    /*#__PURE__*/ (0,jsx_runtime.jsx)("span", {
                                        className: "text-black text-[10px] pl-[41px]",
            ...
            lState === 'finalised' ? /*#__PURE__*/ (0,jsx_runtime.jsxs)("div", {
                ...
                className: "pt-2 flex items-center justify-center gap-[8px]",
                children: [
                    /*#__PURE__*/ (0,jsx_runtime.jsxs)("button", {
                        disabled: btnDisabled,
                        className: (0,tw_merge/* twMerge */.m)('h-[36px] w-[275px] fill-white border-0 flex items-center justify-center gap-2 rounded-2xl bg-[#7918F5] text-white text-sm font-medium', btnDisabled && 'cursor-not-allowed opacity-50'),
        ...
        children: [
            ...
            (activeReceivables == null ? void 0 : activeReceivables.length) > 0 && /*#__PURE__*/ (0,jsx_runtime.jsxs)("section", {
                ...
                children: [
                    ...
                    /*#__PURE__*/ (0,jsx_runtime.jsx)("div", {
                        className: "grid grid-cols-1 lg:grid-cols-2 xl:grid-cols-3 2xl:grid-cols-4 4xl:grid-cols-5 gap-6 justify-start",
            ...
            isOpenClaimModal && /*#__PURE__*/ (0,jsx_runtime.jsx)(GetPaid_Claim, {
                ...
                toggleInvoiceImageDisplay: toggleInvoiceImageDisplay
            }),
...
// EXTERNAL MODULE: ./node_modules/.pnpm/@ethersproject+providers@5.7.2/node_modules/@ethersproject/providers/lib.esm/index.js + 14 modules
var providers_lib_esm = __webpack_require__(31628);
...
// EXTERNAL MODULE: ./node_modules/.pnpm/@web3-react+coinbase-wallet@8.0.34-beta.0_aplsj54t5rmwnbzdw6qrmxqkau/node_modules/@web3-react/coinbase-wallet/dist/index.js
var coinbase_wallet_dist = __webpack_require__(69181);
// EXTERNAL MODULE: ./node_modules/.pnpm/@web3-react+metamask@8.0.28-beta.0_immer@9.0.19+react@18.2.0/node_modules/@web3-react/metamask/dist/index.js
var metamask_dist = __webpack_require__(97313);
// EXTERNAL MODULE: ./node_modules/.pnpm/@web3-react+network@8.0.27-beta.0_immer@9.0.19+react@18.2.0/node_modules/@web3-react/network/dist/index.js
var network_dist = __webpack_require__(36203);
// EXTERNAL MODULE: ./node_modules/.pnpm/@web3-react+walletconnect@8.0.35-beta.0_tlha4vlvnve2uojv7f4y7bbmgm/node_modules/@web3-react/walletconnect/dist/index.js
var walletconnect_dist = __webpack_require__(32576);
...
// EXTERNAL MODULE: ./node_modules/.pnpm/dayjs@1.11.7/node_modules/dayjs/plugin/utc.js
var plugin_utc = __webpack_require__(68957);
var utc_default = /*#__PURE__*/__webpack_require__.n(plugin_utc);
;// CONCATENATED MODULE: ./src/web/utils/pipe.ts
...
function isGreaterThanOrEqualTo(val1, val2) {
    return new BigNumber(val1).comparedTo(new BigNumber(val2)) == 1 || new BigNumber(val1).comparedTo(new BigNumber(val2)) == 0;
}
...
function viewTokenAmount(value, decimals, fixed = 6) {
    if (isEmpty(value) || value === '0') {
        return '0';
    }
    const bigVal = new BigNumber(value);
    const pow = new BigNumber('10').pow(decimals);
    const res = bigVal.dividedBy(pow).toFixed(fixed, 1);
    return res === 'NaN' ? '0' : res;
}
function inputTokenAmount(value, decimals) {
    if (isEmpty(value) || value === '0') {
        return '0';
    }
    const bigVal = new BigNumber(value);
    const pow = new BigNumber('10').pow(decimals);
    const res = bigVal.multipliedBy(pow).toString(10);
    return res === 'NaN' ? '0' : res;
}
function outputTokenAmount(value, decimals) {
    if (isEmpty(value) || value === '0') {
        return '0';
    }
    const bigVal = new BigNumber(value);
    const pow = new BigNumber('10').pow(decimals);
    const res = bigVal.dividedBy(pow).toString(10);
    return res === 'NaN' ? '0' : res;
}
...
function compOrEqual(val1, val2) {
    return new BigNumber(val1).comparedTo(new BigNumber(val2)) == 1 || new BigNumber(val1).comparedTo(new BigNumber(val2)) == 0;
}
function addressFormat(value, digits = 4) {
    if (isEmpty(value)) {
        return '';
    }
    const data = (value.toString().indexOf('0x') > -1 ? '0x' : '') + value.toString().substring(value.toString().indexOf('0x') > -1 ? 2 : 0, digits + 2) + '...' + value.substring(value.length, value.length - digits);
    return data;
}
// 35250000.123400 => 35,250,000.123400
function thousandsValueFormat(value) {
...
function hideMantissa(value) {
    value = value.replace(/\.0+$|(\.[0-9]*[1-9])0+$/, '$1');
    return value;
}
// 35250000.123400 => 35.25m | view utils.test.ts
function beautyAmount({ value , fixed , mantissa =true , thousands =true , poly =true  }, type = 'token') {
...
function tokenDivDecimals(value, decimals, fixed) {
    if (!value) {
        return '0';
    }
    const bigVal = new BigNumber(value);
    const pow = new BigNumber('10').pow(decimals);
    const res = fixed ? bigVal.dividedBy(pow).toFixed(fixed, 1) : bigVal.dividedBy(pow).toString(10);
    return res === 'NaN' ? '0' : res;
}
...
function dateUTCFormat(value, format = 'YYYY-MM-DD') {
    if (!value) {
        return '';
    }
    dayjs_min_default().extend((utc_default()));
    const res = dayjs_min_default()(value).utc().format(format);
    return res;
}
function dateTimeUTCFormat(value) {
    if (!value) {
        return '';
    }
    dayjs.extend(utc);
...
function getDayjs(date, isUTC) {
    if (isUTC) {
        dayjs.extend(utc);
    }
    return date ? dayjs(date) : dayjs();
}
function compareSort(key, sortBy = 'desc') {
...
const Pay = ()=>{
    ...
    const abc = dateUTCFormat(new Date().getMilliseconds());
    (0,react.useEffect)(()=>{
        if (!account) return;
        function mcall() {
        ...
        children: [
            ...
            (activeInvoices == null ? void 0 : activeInvoices.length) > 0 && /*#__PURE__*/ (0,jsx_runtime.jsxs)("section", {
                ...
                children: [
                    ...
                    /*#__PURE__*/ (0,jsx_runtime.jsx)("div", {
                        className: "grid grid-cols-1 lg:grid-cols-2 xl:grid-cols-3 2xl:grid-cols-3 3xl:grid-cols-4 gap-6",
...
/******/ __webpack_require__.O(0, [589,986,998], () => (__webpack_exec__(48671)));
